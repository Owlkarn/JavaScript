...
const numberThreeDigit = number % 1000;

console.log(`В числе ${number} количество сотен: ${Math.floor(numberThreeDigit / 100)}, десятков: ${(Math.floor(numberThreeDigit / 10)) % 10}, единиц: ${numberThreeDigit % 10}`);
