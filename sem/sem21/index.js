...
// const sizeDesktopEl = document.querySelector(".desktop_size");
// printDesktopSize()
//
...
//     sizeDesktopEl.innerHTML = `<p>ширина экрана: ${width}</p><p>высота экрана: ${height}</p>`
// }
...
//     const count = containerEL.querySelector('.box') ? parseInt(containerEL.lastElementChild.textContent) + 1 : 1;
//     containerEL.insertAdjacentHTML("beforeend", `<div class="box">${count}</div>`);
// })
//
...
//     if (containerEL.querySelector('.box')) {
